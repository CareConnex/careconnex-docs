---
description: >-
  Learn how to use the Dr.OZ Patient App to request and manage appointments and
...
* Navigate the Patient App home screen and main menus
* Request a new appointment using an available ticket
* Track an appointment request through confirmation
* View confirmed appointment details
* Change or cancel a confirmed appointment
* Use clinic location, call, and 1:1 Inquiry options from the appointment details
{% endhint %}
...
> 💡 The **Cancel Appointment** and **Change Appointment** buttons are available from the confirmed Appointment Details screen.
